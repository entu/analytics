      ...
      <div class="mt-12 rounded-lg bg-white p-6 shadow">
        <div class="space-y-8">
          <div>
            ...
            <pre class="rounded-md bg-gray-100 p-4 text-xs"><code>&lt;script src="https://analytics.entu.ee/ea.js" data-site="YOUR_SITE_ID" async&gt;&lt;/script&gt;</code></pre>
          ...
          <div>
            ...
            <pre class="rounded-md bg-gray-100 p-4 text-xs"><code>window.analytics.track('button_click', {
  button_name: 'signup',
  page: 'homepage'
})</code></pre>
          </div>
