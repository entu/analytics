...
<template>
  <div class="min-h-screen bg-slate-100 px-4 py-12 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-4xl">
      ...
      <div class="mt-12 rounded-lg bg-white p-6">
        <div class="space-y-8">
          <div>
            <h3 class="mb-2 text-lg font-medium text-slate-900">
              Include the tracking script on your website
            </h3>
            <pre class="overflow-auto rounded-md bg-slate-100 p-4 text-xs"><code>&lt;script src="{{ currentUrl }}/ea.min.js" data-site="YOUR_SITE_ID" crossorigin="anonymous" defer&gt;&lt;/script&gt;</code></pre>
          ...
          <div>
            ...
            <pre class="overflow-auto rounded-md bg-slate-100 p-4 text-xs"><code>window.analytics.track('button_click', {
  button_name: 'signup',
  page: 'homepage'
})</code></pre>
          </div>
